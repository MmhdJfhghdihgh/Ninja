...
async def fetch_info(replied_user, event):
    ...
    if x == 1:
       ...
       caption += f"<b> 𓆩 𝙎𝙊𝙐𝙍𝘾𝞝𓆩𓅃𝘼𝙇𝘼𝙋𝘼𝙏𝙃𓃠𓆪 𓆪 </b> - @ALAPATH "
    ...
    if x == 2:
       ...
       caption += f"<b> • 🌚 | نسبتـه  ⇦  {yoy} </b>\n\n\n"
       caption += f"<b> 𓆩 𝙎𝙊𝙐𝙍𝘾𝞝 𓆩𓅃𝘼𝙇𝘼𝙋𝘼𝙏𝙃𓃠𓆪 𓆪 </b> - @ALAPATH "
...
async def who(event):
    ...
    if replied_user.id == 5093806483 or replied_user.id == 5403568256 or replied_user.id == 5650486652 or replied_user.id == 5811133066
       return await edit_or_reply(zed, "**- دي . . انـهُ مبرمج آلُِسورس 𓄂𓆃 . . انتـه الحيـوان ولك**")
    or event.chat_id == 5093806483
